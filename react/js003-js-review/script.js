...
const { title, publicationDate, pages, genres, author, hasMovieAdaptation } =
  book;
...
// Rest operator
const [var1, ...other] = book.genres;
console.log(var1, other);
...
console.log("Some string" && false); // false
console.log(hasMovieAdaptation && "This book has a movie"); // This book has a movie

// Co the su dung || de set default value
const spanishTranslation = book.translations.spanish || "NOT TRANSLATED";
spanishTranslation;

// Compare || and ??
const weight = 0;
console.log(weight || 100); // 100
